...
data_root = 'data/IOD-Video_COCO_S1/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/GOD_train_S1.json',#'annotations/instances_train2017.json',
        img_prefix=data_root + 'train/',#'train2017/',
        pipeline=train_pipeline),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/GOD_val_S1.json',#'annotations/instances_val2017.json',
