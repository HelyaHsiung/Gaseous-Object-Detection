...
from .class_names import (GODVideo_classes,cityscapes_classes, coco_classes, dataset_aliases,
...
__all__ = [
    ...
    'coco_classes','GODVideo_classes', 'cityscapes_classes', 'dataset_aliases', 'get_classes',
